    ...
    <div class="AdminBackAddEvent">
        ...
        <table style="width: 96%; margin-left: 5%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxNTN" MaxLength="30" CssClass="AllTextBox" Width="65%" placeholder="NTN" runat="server"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxPINCode" MaxLength="4" CssClass="AllTextBox" Width="65%" placeholder="PIN Code" runat="server"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxFBRLogin" MaxLength="8" CssClass="AllTextBox" Width="65%" placeholder="FBR Login" runat="server"></asp:TextBox>
                </td>
            ...
            <tr>
                <td style="width: 10%" >
                    <p>CNIC <span style="color:red">*</span></p>
                </td>

                <td >
                    <asp:TextBox ID="TextBoxCNIC" MaxLength="14" CssClass="AllTextBox" Width="65%" placeholder="CNIC Number" runat="server"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxFBRPassword" MaxLength="30" CssClass="AllTextBox" Width="65%" placeholder="FBR Password" runat="server"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td >
                    <asp:TextBox ID="TextBoxIncorporationNo" MaxLength="7" CssClass="AllTextBox" Width="65%" placeholder="Incorporation Number" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td >
                    <asp:TextBox ID="TextBoxMobile" MaxLength="20" CssClass="AllTextBox" Width="65%" placeholder="Mobile Number" runat="server"></asp:TextBox>
                </td>
            </tr>
